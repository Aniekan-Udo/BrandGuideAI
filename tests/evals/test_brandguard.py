...
# ═══════════════════════════════════════════════════════════════════════════════
# 1.  Groq-backed evaluator LLM for DeepEval metrics
# ═══════════════════════════════════════════════════════════════════════════════

class GroqEvaluatorLLM(DeepEvalBaseLLM):
    """
    Wraps langchain-groq so DeepEval metrics can use Groq instead of OpenAI.
