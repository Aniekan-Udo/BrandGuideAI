  ...
  return (
    <section className="dashboard-panel active">
      ...
      <div className="filter-tabs">
        <button className={`filter-btn ${contentType === 'blog' ? 'active' : ''}`} onClick={() => setContentType('blog')}>Blog Voice</button>
        <button className={`filter-btn ${contentType === 'social' ? 'active' : ''}`} onClick={() => setContentType('social')}>Social Voice</button>
        <button className={`filter-btn ${contentType === 'ad' ? 'active' : ''}`} onClick={() => setContentType('ad')}>Ad Copy Voice</button>
        <button className={`filter-btn ${contentType === 'proposal' ? 'active' : ''}`} onClick={() => setContentType('proposal')}>Proposal Voice</button>
      </div>
